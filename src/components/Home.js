    ...
    return (
        <section className="container mx-auto h-auto md:h-screen py-28 flex justify-center items-center">
            <div className="flex flex-col items-center">
                ...
                <p className="py-8 px-8 md:px-24 lg:px-36 2xl:px-56 md:text-lg xl:text-2xl text-center">What I love doing most is solving business problems by implementing simple, friendly user interfaces.</p>
