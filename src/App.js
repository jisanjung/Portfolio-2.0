...
function App() {
  ...
  return (
    <main className="text-gray-800 bg-gray-100 px-4 md:px-12 lg:px-0"> 
      <Link activeClass="active" to="home" spy={true} smooth={true} offset={50} duration={500} className={`cursor-pointer transition-all z-10 fixed bottom-6 lg:bottom-0 transform rotate-90`}>
